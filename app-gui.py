...
class MainUI(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.title("Team Authentication")
...
class StartPage(tk.Frame):
        ...
        def __init__(self, parent, controller):
            ...
            render = PhotoImage(file='secrity.png')
            img = tk.Label(self, image=render)
            img.image = render
            img.grid(row=0, column=1, rowspan=4, sticky="nsew")
            label = tk.Label(self, text="        Team Verification         ", font=self.controller.title_font,fg="#263942")
            label.grid(row=0, sticky="ew")
            button1 = tk.Button(self, text="   Add your position for authentication  ", fg="#ffffff", bg="#000000",command=lambda: self.controller.show_frame("PageOne"))
            button2 = tk.Button(self, text="  Authenticate your position to enter the app  ", fg="#ffffff", bg="#000000",command=lambda: self.controller.show_frame("PageTwo"))
...
class PageOne(tk.Frame):
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
        self.controller = controller
        tk.Label(self, text="Enter your position", fg="#263942", font='Helvetica 12 bold').grid(row=0, column=0, pady=10, padx=5)
...
class PageTwo(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        global names
        self.controller = controller
        tk.Label(self, text="Select Position ", fg="#263942", font='Helvetica 12 bold').grid(row=0, column=0, padx=10, pady=10)
